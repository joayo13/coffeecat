    ...
    <nav className="nav flex fixed w-full items-center justify-between md:h-32 h-16 px-2 bg-neutral-800 text-neutral-300 z-40">
      ...
      <div className="flex gap-2">
        ...
        <div className="hb w-8 h-8 md:w-16 md:h-16">
          <div style={ mobileMenuActive ? {animation: 'hb1 0.5s forwards'} : null} className="hb1"></div>
          <div style={ mobileMenuActive ? {animation: 'hb2 0.25s forwards'} : null} className="hb2"></div>
          <div style={ mobileMenuActive ? {animation: 'hb3 0.5s forwards'} : null} className="hb3"></div>
        </div>
        </button>
      </div>
      {/* <ul>
